...
#define IntCurveSurface_QuadricCurveFunc QuadCurvFuncOfQuadCurvExactInterCSurf
#define IntCurveSurface_QuadricCurveFunc_hxx <asiAlgo_HlrQuadCurvFuncOfQuadCurvExactInterCSurf.h>
