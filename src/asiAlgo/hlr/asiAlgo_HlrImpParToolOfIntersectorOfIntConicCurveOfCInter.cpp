...
#define IntImpParGen_ImpParTool ImpParToolOfIntersectorOfIntConicCurveOfCInter
#define IntImpParGen_ImpParTool_hxx <asiAlgo_HlrImpParToolOfIntersectorOfIntConicCurveOfCInter.h>
