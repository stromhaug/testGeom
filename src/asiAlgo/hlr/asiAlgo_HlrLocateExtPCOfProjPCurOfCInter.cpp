...
#define Extrema_PCLocF PCLocFOfLocateExtPCOfProjPCurOfCInter
#define Extrema_PCLocF_hxx <asiAlgo_HlrPCLocFOfLocateExtPCOfProjPCurOfCInter.h>
#define Extrema_SeqPCOfPCLocF Extrema_SequenceOfPOnCurv2d
#define Extrema_SeqPCOfPCLocF_hxx <Extrema_SequenceOfPOnCurv2d.hxx>
#define Extrema_SeqPCOfPCLocF Extrema_SequenceOfPOnCurv2d
#define Extrema_SeqPCOfPCLocF_hxx <Extrema_SequenceOfPOnCurv2d.hxx>
#define Extrema_GenLocateExtPC LocateExtPCOfProjPCurOfCInter
#define Extrema_GenLocateExtPC_hxx <asiAlgo_HlrLocateExtPCOfProjPCurOfCInter.h>
