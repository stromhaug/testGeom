...
#ifndef asiAlgo_HLRBRep_TheProjPCurOfCInter_HeaderFile
#define asiAlgo_HLRBRep_TheProjPCurOfCInter_HeaderFile
...
public:
  ...
  asiAlgo_EXPORT static Standard_Real FindParameter (const Standard_Address& C, const gp_Pnt2d& Pnt, const Standard_Real Tol);
  ...
  asiAlgo_EXPORT static Standard_Real FindParameter (const Standard_Address& C, const gp_Pnt2d& Pnt, const Standard_Real LowParameter, const Standard_Real HighParameter, const Standard_Real Tol);
