...
#ifndef asiAlgo_HLRBRep_ThePolygonOfInterCSurf_HeaderFile
#define asiAlgo_HLRBRep_ThePolygonOfInterCSurf_HeaderFile
...
public:
  ...
  asiAlgo_EXPORT PolygonOfInterCSurf(const gp_Lin& Curve, const Standard_Integer NbPnt);

  asiAlgo_EXPORT PolygonOfInterCSurf(const gp_Lin& Curve, const Standard_Real U1, const Standard_Real U2, const Standard_Integer NbPnt);

  asiAlgo_EXPORT PolygonOfInterCSurf(const gp_Lin& Curve, const TColStd_Array1OfReal& Upars);
...
protected:
  ...
  asiAlgo_EXPORT void Init (const gp_Lin& Curve);

  asiAlgo_EXPORT void Init (const gp_Lin& Curve, const TColStd_Array1OfReal& Upars);
