...
IMPLEMENT_STANDARD_RTTIEXT(PolyAlgo,Standard_Transient)
...
//purpose  :
//=======================================================================
PolyAlgo::PolyAlgo(ActAPI_ProgressEntry progress,
...
//purpose  :
//=======================================================================
TopoDS_Shape& PolyAlgo::Shape (const Standard_Integer theIndex)
{
...
//purpose  :
//=======================================================================
void PolyAlgo::Remove (const Standard_Integer theIndex)
{
  Standard_OutOfRange_Raise_if (theIndex == 0 || theIndex > myShapes.Length(),
				"PolyAlgo::Remove : unknown Shape");
...
//purpose  :
//=======================================================================
Standard_Integer PolyAlgo::Index (const TopoDS_Shape& theShape) const
{
...
//purpose  :
//=======================================================================
TopoDS_Shape PolyAlgo::MakeShape() const
{
  if (myShapes.IsEmpty())
  {
    return TopoDS_Shape();
...
//purpose  :
//=======================================================================
Standard_Integer PolyAlgo::InitShape (const TopoDS_Shape& theShape,
...
//purpose  :
//=======================================================================
void PolyAlgo::StoreShell (const TopoDS_Shape& theShape,
    ...
    for (; aFaceExp.More(); aFaceExp.Next())
    {
      ...
      if (!aTr.IsNull())
      {
        if (theShapeMap2.Add (aFace))
        {
          ...
          {
            std::cout << " PolyAlgo::StoreShell : Face ";
...
//purpose  :
//=======================================================================
Standard_Boolean PolyAlgo::Normal (const Standard_Integer theNodeIndex,
...
#ifdef OCCT_DEBUG
    if (DoError) {
      std::cout << "PolyAlgo::Normal : AverageNormal error";
      std::cout << std::endl;
    }
#endif
  }
...
//purpose  :
//=======================================================================
Standard_Boolean PolyAlgo::AverageNormal (const Standard_Integer iNode,
...
//purpose  :
//=======================================================================
void PolyAlgo::AddNormalOnTriangle (const Standard_Integer theITri,
...
//purpose  :
//=======================================================================
void PolyAlgo::InitBiPointsWithConnexity (const Standard_Integer theIEdge,
                                                  TopoDS_Edge& theEdge,
  ...
  if (theIsConnex)
  {
    ...
    if (aNbConnex == 1)
    {
      ...
      if (!aHPol[0].IsNull())
      {
        ...
        {
          std::cout << " PolyAlgo::InitBiPointsWithConnexity : ";
      ...
      {
        std::cout << "PolyAlgo::InitBiPointsWithConnexity : Edge ";
...
//purpose  :
//=======================================================================
void PolyAlgo::Interpolation (HLRAlgo_ListOfBPoint& theList,
                                      Standard_Real& theX1,
                                      Standard_Real& theY1,
                                      Standard_Real& theZ1,
                                      Standard_Real& theX2,
...
//purpose  :
//=======================================================================
Standard_Boolean PolyAlgo::Interpolation (const Standard_Real theU1,
...
//purpose  :
//=======================================================================
void PolyAlgo::MoveOrInsertPoint (HLRAlgo_ListOfBPoint& theList,
                                          Standard_Real& theX1,
                                          Standard_Real& theY1,
                                          Standard_Real& theZ1,
                                          Standard_Real& theX2,
                                          ...
                                          const Standard_Integer theFlag) const
{
  ...
  if (anIns3 && themP3P1)                               // P1 ---> P3
  {
    if (!(theNod11Indices.Flag & NMsk_Vert) && theCoef3 < myTolSta)
    {
      ...
      {
        std::cout << " PolyAlgo::MoveOrInsertPoint : ";
...
//purpose  :
//=======================================================================
void PolyAlgo::InsertOnOutLine (NCollection_Array1<Handle(HLRAlgo_PolyInternalData)>& thePID)
{
  HLRAlgo_Array1OfTData* aTData2 = NULL;
  HLRAlgo_Array1OfPISeg* aPISeg2 = NULL;
  HLRAlgo_Array1OfPINod* aPINod2 = NULL;
...
//purpose  :
//=======================================================================
void PolyAlgo::CheckFrBackTriangles (HLRAlgo_ListOfBPoint& theList,
                                             NCollection_Array1<Handle(HLRAlgo_PolyInternalData)>& thePID)
{
...
//purpose  :
//=======================================================================
void PolyAlgo::FindEdgeOnTriangle (const HLRAlgo_TriangleData& theTriangle,
...
//purpose  :
//=======================================================================
void PolyAlgo::ChangeNode (const Standard_Integer theIp1,
                                   const Standard_Integer theIp2,
                                   ...
                                   HLRAlgo_Array1OfPINod& thePINod) const
{
  ...
  if (theIsFirst)
  {
    ...
    else
    {
      ...
      if (DoError)
      {
        std::cout << "PolyAlgo::ChangeNode between " << theIp1;
  ...
  else
  {
    ...
    else
    {
      ...
      if (DoError)
      {
        std::cout << "PolyAlgo::ChangeNode between " << theIp2;
...
//purpose  :
//=======================================================================
void PolyAlgo::UpdateAroundNode (const Standard_Integer theINode,
                                         HLRAlgo_PolyInternalNode::NodeIndices& theNod1Indices,
                                         HLRAlgo_Array1OfTData& theTData,
                                         HLRAlgo_Array1OfPISeg& thePISeg,
                                         HLRAlgo_Array1OfPINod& thePINod) const
...
//purpose  :
//=======================================================================
void  PolyAlgo::OrientTriangle (const Standard_Integer theITri,
                                        ...
                                        HLRAlgo_PolyInternalNode::NodeData& theNod3RValues) const
{
  ...
  if (o1 && o2 && o3)
  {
    ...
    if (DoTrace)
    {
      std::cout << "PolyAlgo::OrientTriangle : OnOutL";
  ...
  else
  {
    ...
    if (aD12Norm <= 1.e-10)
    {
      ...
      if (DoTrace)
      {
        std::cout << "PolyAlgo::OrientTriangle : Flat";
        std::cout << " triangle " << theITri << std::endl;
      }
#endif
      theTriangle.Flags |=  HLRAlgo_PolyMask_FMskFlat;
...
//purpose  :
//=======================================================================
Standard_Boolean PolyAlgo::Triangles (const Standard_Integer theIp1,
                                              const Standard_Integer theIp2,
                                              HLRAlgo_PolyInternalNode::NodeIndices& theNod1Indices,
                                              HLRAlgo_Array1OfPISeg*& thePISeg,
                                              ...
                                              Standard_Integer& theITri2) const
{
  ...
  if (DoError)
  {
    std::cout << "PolyAlgo::Triangles : error";
...
//purpose  :
//=======================================================================
Standard_Boolean PolyAlgo::NewNode (HLRAlgo_PolyInternalNode::NodeData& theNod1RValues,
                                            HLRAlgo_PolyInternalNode::NodeData& theNod2RValues,
...
//purpose  :
//=======================================================================
void PolyAlgo::UVNode (HLRAlgo_PolyInternalNode::NodeData& theNod1RValues,
                               HLRAlgo_PolyInternalNode::NodeData& theNod2RValues,
                               const Standard_Real theCoef1,
                               Standard_Real& theU3,
...
//purpose  :
//=======================================================================
void PolyAlgo::CheckDegeneratedSegment (HLRAlgo_PolyInternalNode::NodeIndices& theNod1Indices,
                                                HLRAlgo_PolyInternalNode::NodeData& theNod1RValues,
                                                HLRAlgo_PolyInternalNode::NodeIndices& theNod2Indices,
...
//purpose  :
//=======================================================================
void PolyAlgo::UpdateOutLines (HLRAlgo_ListOfBPoint& theList,
                                       NCollection_Array1<Handle(HLRAlgo_PolyInternalData)>& thePID)
{
  Standard_Real X1  ,Y1  ,Z1  ,X2  ,Y2  ,Z2;
  Standard_Real XTI1,YTI1,ZTI1,XTI2,YTI2,ZTI2;
...
//purpose  :
//=======================================================================
void PolyAlgo::UpdateEdgesBiPoints (HLRAlgo_ListOfBPoint& theList,
                                            ...
                                            const Standard_Boolean theIsClosed)
{
  ...
  for (HLRAlgo_ListIteratorOfListOfBPoint aBPntIter (theList); aBPntIter.More(); aBPntIter.Next())
  {
    ...
    if (aIndices.FaceConex1 != 0 && aIndices.FaceConex2 != 0)
    {
      ...
      {
        std::cout << "PolyAlgo::UpdateEdgesBiPoints : error ";
...
//purpose  :
//=======================================================================
void PolyAlgo::UpdatePolyData (NCollection_Array1<Handle(HLRAlgo_PolyData)>& thePD,
                                       NCollection_Array1<Handle(HLRAlgo_PolyInternalData)>& thePID,
                                       const Standard_Boolean theIsClosed)
{
  const Standard_Integer aNbFaces = myFMap.Extent();
  for (Standard_Integer aFaceIter = 1; aFaceIter <= aNbFaces; ++aFaceIter)
  {
    ...
    for (Standard_Integer aTriIter = 1; aTriIter <= aNbTris; ++aTriIter)
    {
      ...
      if (!(anOT.Flags & HLRAlgo_PolyMask_FMskSide))
      {
        ...
        {
          std::cout << "PolyAlgo::ReverseBackTriangle :";
...
//purpose  :
//=======================================================================
void PolyAlgo::TMultiply (Standard_Real& theX,
                                  Standard_Real& theY,
                                  Standard_Real& theZ,
...
//purpose  :
//=======================================================================
void PolyAlgo::TTMultiply (Standard_Real& theX,
                                   Standard_Real& theY,
                                   Standard_Real& theZ,
                                   const Standard_Boolean theVPO) const
{
...
//purpose  :
//=======================================================================
void PolyAlgo::TIMultiply (Standard_Real& theX,
                                   Standard_Real& theY,
                                   Standard_Real& theZ,
                                   const Standard_Boolean theVPO) const
{
...
//purpose  :
//=======================================================================
HLRAlgo_BiPoint::PointsT& PolyAlgo::Hide (HLRAlgo_EdgeStatus& theStatus,
...
//purpose  :
//=======================================================================
HLRAlgo_BiPoint::PointsT& PolyAlgo::Show (TopoDS_Shape& theShape,
                                                  Standard_Boolean& theReg1,
                                                  Standard_Boolean& theRegn,
                                                  Standard_Boolean& theOutl,
                                                  Standard_Boolean& theIntl)
...
//purpose  :
//=======================================================================
TopoDS_Shape PolyAlgo::OutLinedShape (const TopoDS_Shape& theShape) const
{
  if (theShape.IsNull())
  {
    return TopoDS_Shape();
