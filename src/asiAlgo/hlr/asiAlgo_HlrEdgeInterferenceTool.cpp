...
//=======================================================================
 ...
 void EdgeInterferenceTool::InitVertices()
{ cur = 0; }
...
//=======================================================================
 ...
 Standard_Boolean
EdgeInterferenceTool::MoreVertices() const
{ return cur < 2; }
...
//=======================================================================
 ...
 void EdgeInterferenceTool::NextVertex()
{ cur++; }
...
//=======================================================================
 ...
 const HLRAlgo_Intersection&
EdgeInterferenceTool::CurrentVertex
  () const
{ return inter[cur]; }
...
//=======================================================================
 ...
 TopAbs_Orientation
EdgeInterferenceTool::CurrentOrientation
  () const
{
...
//=======================================================================
 ...
 Standard_Real
EdgeInterferenceTool::CurrentParameter() const
...
//=======================================================================
 ...
 Standard_Boolean
EdgeInterferenceTool::IsPeriodic() const
...
void EdgeInterferenceTool::LoadEdge()
{
  Standard_Real p1,p2;
  Standard_ShortReal t1,t2;
  Array1OfEData& ED = myDS->EDataArray();
  EdgeData& ed = ED(myDS->Edge());
...
void EdgeInterferenceTool::EdgeGeometry
...
Standard_Boolean EdgeInterferenceTool::SameInterferences
...
Standard_Boolean EdgeInterferenceTool::SameVertexAndInterference
  (const HLRAlgo_Interference& I) const
{
...
void EdgeInterferenceTool::InterferenceBoundaryGeometry
