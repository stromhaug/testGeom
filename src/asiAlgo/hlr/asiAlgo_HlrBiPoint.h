...
#ifndef asiAlgo_HLRBRep_BiPoint_HeaderFile
#define asiAlgo_HLRBRep_BiPoint_HeaderFile
...
public:
  ...
  BiPoint (const Standard_Real x1, const Standard_Real y1, const Standard_Real z1,
