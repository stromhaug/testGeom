...
HLRAlgo_Projector & InternalAlgo::Projector ()
{ return myProj; }

//-----------------------------------------------------------------------------

void InternalAlgo::Update ()
{
  if (!myShapes.IsEmpty()) {
...
void InternalAlgo::Remove (const Standard_Integer I)
{
...
void InternalAlgo::ShapeData (const Standard_Integer I,
				      const Handle(Standard_Transient)& SData)
{
  Standard_OutOfRange_Raise_if
    (I == 0 || I > myShapes.Length(),
...
Standard_Integer InternalAlgo::NbShapes () const
...
void InternalAlgo::SelectEdge (const Standard_Integer I)
{
  if (!myDS.IsNull()) {
    Standard_OutOfRange_Raise_if
      (I == 0 || I > myShapes.Length(),
...
void InternalAlgo::SelectFace (const Standard_Integer I)
{
  if (!myDS.IsNull()) {
    Standard_OutOfRange_Raise_if
      (I == 0 || I > myShapes.Length(),
...
void InternalAlgo::ShowAll (const Standard_Integer I)
{
  if (!myDS.IsNull()) {
    Standard_OutOfRange_Raise_if
      (I == 0 || I > myShapes.Length(),
...
void InternalAlgo::HideAll (const Standard_Integer I)
{
  if (!myDS.IsNull()) {
    Standard_OutOfRange_Raise_if
      (I == 0 || I > myShapes.Length(),
...
void InternalAlgo::Hide (const Standard_Integer I)
{
  if (!myDS.IsNull()) {
    Standard_OutOfRange_Raise_if
      (I == 0 || I > myShapes.Length(),
...
void InternalAlgo::HideSelected (const Standard_Integer I,
...
void InternalAlgo::Debug (const Standard_Boolean deb)
{ myDebug = deb; }

//-----------------------------------------------------------------------------

Standard_Boolean InternalAlgo::Debug () const
{ return myDebug; }
