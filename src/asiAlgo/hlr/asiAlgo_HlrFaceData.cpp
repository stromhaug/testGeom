...
void FaceData::Set (const TopoDS_Face& FG,
			    const TopAbs_Orientation Or,
			    const Standard_Boolean Cl,
			    const Standard_Integer NW)
{
  Closed(Cl);
  Geometry().SetSurface(FG);
...
void FaceData::SetWire (const Standard_Integer WI,
...
void FaceData::SetWEdge (const Standard_Integer WI,
