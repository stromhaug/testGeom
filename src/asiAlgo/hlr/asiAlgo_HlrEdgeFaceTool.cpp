...
//purpose  :
//=======================================================================
Standard_Real EdgeFaceTool::CurvatureValue
  ...
  const gp_Dir& Tg)
{
  ...
  ((Surface*)F)->D2(U,V,P,D1U,D1V,D2U,D2V,D2UV);
                                               ...
                                               Standard_Real& V)
{
  ...
  if (BRep_Tool::CurveOnSurface
      (((Curve  *)E)->AccessCurve().Edge(),
       ((Surface*)F)->AccessSurface().Face(),pfbid,plbid).IsNull())
  {
    BRepExtrema_ExtPF proj
      (BRepLib_MakeVertex(((Curve*)E)->Value3D(Par)),
       ((Surface*)F)->AccessSurface().Face());
