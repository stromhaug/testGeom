...
//=======================================================================
ShapeBounds::
ShapeBounds (const Handle(HLRTopoBRep_OutLiner)& S,
...
void ShapeBounds::Translate (const Standard_Integer NV,
...
void ShapeBounds::Sizes (Standard_Integer& NV,
				 Standard_Integer& NE,
...
void ShapeBounds::Bounds (Standard_Integer& V1,
				  Standard_Integer& V2,
				  Standard_Integer& E1,
				  Standard_Integer& E2,
				  Standard_Integer& F1,
