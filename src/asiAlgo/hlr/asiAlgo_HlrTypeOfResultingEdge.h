...
#ifndef asiAlgo_HLRBRep_TypeOfResultingEdge_HeaderFile
#define asiAlgo_HLRBRep_TypeOfResultingEdge_HeaderFile
...
//! Identifies the type of resulting edge of PreciseAlgo
