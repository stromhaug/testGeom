...
//=======================================================================
Handle(Data)
ShapeToHlr::Load(const Handle(HLRTopoBRep_OutLiner)& S,
			 ...
			 const Standard_Integer nbIso)
{
  ...
  Handle(Data) DS = new Data (nbVert, nbEdge, nbFace);
  EdgeData* ed = NULL;
...
void
ShapeToHlr::ExploreFace(const Handle(HLRTopoBRep_OutLiner)& S,
				const Handle(Data)& DS,
				...
				const Standard_Boolean closed)
{
  ...
  FaceData& fd = DS->FDataArray().ChangeValue(i);
...
void
ShapeToHlr::ExploreShape (const Handle(HLRTopoBRep_OutLiner)& S,
				  const Handle(Data)& DS,
				  const TopTools_IndexedMapOfShape& FM,
				  const TopTools_IndexedMapOfShape& EM)
{
