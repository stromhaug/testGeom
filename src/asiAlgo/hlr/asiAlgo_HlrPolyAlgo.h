...
#ifndef asiAlgo_HLRBRep_PolyAlgo_HeaderFile
#define asiAlgo_HLRBRep_PolyAlgo_HeaderFile
...
class PolyAlgo;
DEFINE_STANDARD_HANDLE(PolyAlgo, ActAPI_IAlgorithm)
...
//! PolyAlgo works with three types of entity:
...
//! PolyAlgo is based on the principle
...
//! PolyAlgo works with a polyhedral
//! simplification of the shape whereas
//! PreciseAlgo takes the shape itself into
//! account. When you use PreciseAlgo, you
//! obtain an exact result, whereas, when you use
//! PolyAlgo, you reduce computation
//! time but obtain polygonal segments.
//! An PolyAlgo object provides a framework for:
...
class PolyAlgo : public ActAPI_IAlgorithm
{
public:
  ...
  asiAlgo_EXPORT PolyAlgo(ActAPI_ProgressEntry progress = nullptr,
                          ActAPI_PlotterEntry  plotter  = nullptr);

  Standard_Integer NbShapes() const { return myShapes.Length(); }

  asiAlgo_EXPORT TopoDS_Shape& Shape (const Standard_Integer I);
  ...
  asiAlgo_EXPORT Standard_Integer Index (const TopoDS_Shape& S) const;
  ...
  asiAlgo_EXPORT HLRAlgo_BiPoint::PointsT&
    Hide (HLRAlgo_EdgeStatus& status,
          TopoDS_Shape& S,
  ...
  asiAlgo_EXPORT HLRAlgo_BiPoint::PointsT& Show (TopoDS_Shape& S, Standard_Boolean& reg1, Standard_Boolean& regn, Standard_Boolean& outl, Standard_Boolean& intl);

  //! Make a shape  with  the internal outlines in  each
  //! face.
  asiAlgo_EXPORT TopoDS_Shape OutLinedShape (const TopoDS_Shape& S) const;

  Standard_Boolean Debug() const { return myDebug; }

  void Debug (const Standard_Boolean theDebug) { myDebug = theDebug; }

  DEFINE_STANDARD_RTTIEXT(PolyAlgo,ActAPI_IAlgorithm)

private:

  asiAlgo_EXPORT TopoDS_Shape MakeShape() const;

  asiAlgo_EXPORT Standard_Integer InitShape (const TopoDS_Shape& Shape, Standard_Boolean& IsoledF, Standard_Boolean& IsoledE);

  asiAlgo_EXPORT void StoreShell (const TopoDS_Shape& theShape,
  ...
  asiAlgo_EXPORT Standard_Boolean Normal (const Standard_Integer theINode,
  ...
  asiAlgo_EXPORT Standard_Boolean AverageNormal (const Standard_Integer theINode,
  ...
  asiAlgo_EXPORT void AddNormalOnTriangle (const Standard_Integer theITri,
  ...
  asiAlgo_EXPORT void InitBiPointsWithConnexity (const Standard_Integer theIEdge,
                                                  TopoDS_Edge& theEdge,
  ...
  asiAlgo_EXPORT void InsertOnOutLine (NCollection_Array1<Handle(HLRAlgo_PolyInternalData)>& thePID);

  asiAlgo_EXPORT void CheckFrBackTriangles (HLRAlgo_ListOfBPoint& theList,
                                             NCollection_Array1<Handle(HLRAlgo_PolyInternalData)>& thePID);

  asiAlgo_EXPORT void FindEdgeOnTriangle (const HLRAlgo_TriangleData& theTriangle, const Standard_Integer ip1, const Standard_Integer ip2, Standard_Integer& jtrouv, Standard_Boolean& isDirect) const;

  asiAlgo_EXPORT void ChangeNode (const Standard_Integer theIp1,
  ...
  asiAlgo_EXPORT void UpdateAroundNode (const Standard_Integer theINode,
                                         HLRAlgo_PolyInternalNode::NodeIndices& theNodeIndices,
                                         HLRAlgo_Array1OfTData& theTData,
                                         HLRAlgo_Array1OfPISeg& thePISeg,
                                         HLRAlgo_Array1OfPINod& thePINod) const;

  asiAlgo_EXPORT void OrientTriangle (const Standard_Integer iTri, HLRAlgo_TriangleData& theTriangle, HLRAlgo_PolyInternalNode::NodeIndices& theNodeIndices1, HLRAlgo_PolyInternalNode::NodeData& Nod1RValues, HLRAlgo_PolyInternalNode::NodeIndices& theNodeIndices2, HLRAlgo_PolyInternalNode::NodeData& Nod2RValues, HLRAlgo_PolyInternalNode::NodeIndices& theNodeIndices3, HLRAlgo_PolyInternalNode::NodeData& Nod3RValues) const;

  asiAlgo_EXPORT Standard_Boolean Triangles (const Standard_Integer ip1, const Standard_Integer ip2, HLRAlgo_PolyInternalNode::NodeIndices& Nod1Indices, HLRAlgo_Array1OfPISeg*& PISeg, Standard_Integer& iTri1, Standard_Integer& iTri2) const;

  asiAlgo_EXPORT Standard_Boolean NewNode (HLRAlgo_PolyInternalNode::NodeData& Nod1RValues, HLRAlgo_PolyInternalNode::NodeData& Nod2RValues, Standard_Real& coef1, Standard_Boolean& moveP1) const;

  asiAlgo_EXPORT void UVNode (HLRAlgo_PolyInternalNode::NodeData& Nod1RValues, HLRAlgo_PolyInternalNode::NodeData& Nod2RValues, const Standard_Real coef1, Standard_Real& U3, Standard_Real& V3) const;

  asiAlgo_EXPORT void CheckDegeneratedSegment (HLRAlgo_PolyInternalNode::NodeIndices& Nod1Indices, HLRAlgo_PolyInternalNode::NodeData& Nod1RValues, HLRAlgo_PolyInternalNode::NodeIndices& Nod2Indices, HLRAlgo_PolyInternalNode::NodeData& Nod2RValues) const;

  asiAlgo_EXPORT void UpdateOutLines (HLRAlgo_ListOfBPoint& theList,
                                       NCollection_Array1<Handle(HLRAlgo_PolyInternalData)>& thePID);

  asiAlgo_EXPORT void UpdateEdgesBiPoints (HLRAlgo_ListOfBPoint& theList,
                                            const NCollection_Array1<Handle(HLRAlgo_PolyInternalData)>& thePID,
                                            const Standard_Boolean theIsClosed);

  asiAlgo_EXPORT void UpdatePolyData (NCollection_Array1<Handle(HLRAlgo_PolyData)>& thePD,
                                       NCollection_Array1<Handle(HLRAlgo_PolyInternalData)>& thePID,
                                       const Standard_Boolean theClosed);

  asiAlgo_EXPORT void TMultiply (Standard_Real& X, Standard_Real& Y, Standard_Real& Z, const Standard_Boolean VecPartOnly = Standard_False) const;
  ...
  asiAlgo_EXPORT void TTMultiply (Standard_Real& X, Standard_Real& Y, Standard_Real& Z, const Standard_Boolean VecPartOnly = Standard_False) const;
  ...
  asiAlgo_EXPORT void TIMultiply (Standard_Real& X, Standard_Real& Y, Standard_Real& Z, const Standard_Boolean VecPartOnly = Standard_False) const;
